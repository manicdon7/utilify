  ...
  const handlePurchase = async (planId: string) => {
    ...
    try {
      ...
      const options = {
        ...
        name: "Utilify",
        description: `${planId.charAt(0).toUpperCase() + planId.slice(1)} Plan - AI Credits`,
        ...
        handler: async (response: { razorpay_order_id: string; razorpay_payment_id: string; razorpay_signature: string }) => {
          try {
            ...
            setMessage({ type: "success", text: `Payment successful! ${verifyData.credits} credits added.` });
